# construindo uma interface de agente de estoque com streamlit e langchain
# este aplicativo permite que os usuários façam perguntas sobre o estoque de produtos, podendo selecionar diferentes modelos gpt para responder às consultas
...
os.environ["OPENAI_API_KEY"] = os.getenv("OPENAI_API_KEY") or config("OPENAI_API_KEY")
